...
define('flixnetto/tests/components/popular-movies/popular-movie-list.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components/popular-movies/popular-movie-list.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/popular-movies/popular-movie-list.js should pass jshint.');
  });
});
...
define('flixnetto/tests/integration/components/popular-movies/popular-movie-list-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('popular-movies/popular-movie-list', 'Integration | Component | popular movies/popular movie list', {
    integration: true,
    ...
    beforeEach: function beforeEach() {
      this.setProperties({
        ...
        onViewMovieDetails: function onViewMovieDetails() {}
      });
    }
  });

  (0, _emberQunit.test)('"popular-movie-list" component and its contents render', function (assert) {
    assert.expect(5);
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['inline', 'popular-movies/popular-movie-list', [], ['popularMovies', ['subexpr', '@mut', [['get', 'popularMovies', ['loc', [null, [2, 34], [2, 47]]]]], [], []], 'onPageChange', ['subexpr', 'route-action', [['get', 'onPageChange', ['loc', [null, [3, 47], [3, 59]]]]], [], ['loc', [null, [3, 33], [3, 60]]]], 'onSelectPreviousPage', ['subexpr', 'route-action', [['get', 'onSelectPreviousPage', ['loc', [null, [4, 55], [4, 75]]]]], [], ['loc', [null, [4, 41], [4, 76]]]], 'onSelectNextPage', ['subexpr', 'route-action', [['get', 'onSelectNextPage', ['loc', [null, [5, 51], [5, 67]]]]], [], ['loc', [null, [5, 37], [5, 68]]]], 'onViewMovieDetails', ['subexpr', 'route-action', [['get', 'onViewMovieDetails', ['loc', [null, [6, 53], [6, 71]]]]], [], ['loc', [null, [6, 39], [6, 72]]]]], ['loc', [null, [1, 0], [6, 74]]]]],
        locals: [],
        templates: []
      };
    })()));
...
define('flixnetto/tests/integration/components/popular-movies/popular-movie-list-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components/popular-movies/popular-movie-list-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/popular-movies/popular-movie-list-test.js should pass jshint.');
  });
});
