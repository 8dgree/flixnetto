...
moduleForComponent('popular-movies', 'Integration | Component | popular movies', {
  integration: true,
...
test('"popular-movies" and its contents render', function(assert) {
  assert.expect(2);

  this.render(hbs`{{popular-movies
